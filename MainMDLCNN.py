...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', type=str, default='mnistImage',
    ...
    # training options
    parser.add_argument('-niters', type=int, default=50001, help='number of training iteration')
    ...
    parser.add_argument('-classifier', type=str, default='~/github/data/mnist/mnist_cnn.t7', help='classifier for MDL')
